...
namespace Assets.DoReMi.Scripts
{
    public class APModel : MonoBehaviour
    {
        ...
        public int gainEmitterDBi;
        public int gainReceiverDBi;
        ...
        private int GetSignalStrengthAt(Vector3 pos)
        {
            ...
            return _constValue - (int)(20 * Mathf.Log10(dist));
        }

        private void Awake()
        {
            // Computing the const part of the Friis formula in our model
            _constValue = powerEmitterDBm + gainEmitterDBi + gainReceiverDBi + (int)(20 * Mathf.Log10((float)(3e8 / (4 * Mathf.PI * wifiFrequencyHz))));
